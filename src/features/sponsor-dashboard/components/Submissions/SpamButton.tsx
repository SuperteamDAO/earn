...
export const SpamButton = ({ listingSlug, isMultiSelectOn }: Props) => {
  ...
  return (
    <>
      <Button
        variant="destructive"
        className={`rounded-lg border disabled:opacity-100 max-sm:shrink-0 max-sm:px-3 max-sm:text-sm ${
          isMarkedAsSpam
      ...
      >
        <LucideFlag className="size-1 text-orange-500 max-sm:size-3.5" />
