...
export function Hero() {
  ...
  return (
    <>
      <div className="md:[1rem] relative flex w-full flex-col items-center justify-start overflow-hidden pb-[4rem]">
        <div>
          <div className="relative flex w-full flex-col items-center gap-[1.875rem] bg-[#F8FAFC] px-[1.875rem] pt-[9.375rem] text-center">
            <h1
              className={cn(
                'max-w-[45rem] font-semibold leading-[1.15em] tracking-[-0.04em] text-gray-700',
