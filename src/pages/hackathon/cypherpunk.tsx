    ...
    <Default
      ...
      meta={
        <>
          <meta
            name="twitter:image"
            content={`https://res.cloudinary.com/dgvnuwspr/image/upload/assets/hackathon/cypherpunk/og-image.png`}
          />
          <Meta
            ...
            og="https://res.cloudinary.com/dgvnuwspr/image/upload/assets/hackathon/cypherpunk/og-image.png"
          />
        </>
      }
    >
