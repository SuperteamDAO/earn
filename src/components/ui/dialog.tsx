      ...
      >
        ...
        {!hideCloseIcon && (
          <DialogPrimitive.Close
            className={cn(
              'ring-offset-background data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-3 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none',
